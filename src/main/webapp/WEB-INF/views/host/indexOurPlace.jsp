            ...
            <div class="nav">
              ...
              >
                <nav class="sb-sidenav-menu-nested nav">
                  <a class="nav-link" href="tablesAdmin.html">내 프로필 관리</a>
                </nav>
              </div>
              <a
                class="nav-link collapsed"
              ...
              >
                <nav class="sb-sidenav-menu-nested nav">
                  <a class="nav-link" href="tablesAdmin.html">내 장소 관리</a>
                  <a class="nav-link" href="tablesAdmin.html">내 장소 등록</a>
                  <a class="nav-link" href="tablesAdmin.html">리뷰 관리</a>
                </nav>
              </div>
