...
<head>
 ...
 <link href="${pageContext.request.contextPath}/resources/css/sample.css" rel="stylesheet" type="text/css">
    <!--달력 script-->
...
<form action="startingReserv.do" method="post">
    ...
    <div class="h_row_center" style="position: relative;width: 1160px; height: 100px; margin:auto;"><img
        ...
        <div class="h_row_center" style="position: absolute; right: 0px;">
            <div onclick="hourplace_v2.userLog('W', '/place/29464', 'click', 'tab', 'all');toggle_category_all()"
            ...
            <div onclick="hourplace_v2.userLog('W', '/place/29464', 'click', 'tab', 'hosting');window.location.href='/info/hosting'"
    ...
    <!--장소 이름 위 카테고리, 위치 -->
    <div class="h_row_center" style="margin-top: 20px; position: relative; left: 200px;">
        <p
    ...
    <div style="position: relative; left: 200px;">
        ...
        <!--리뷰별점 , 리뷰 보기-->
        <!--onclick -- 별점 불러오는 메서드-->
        <div onclick="go_feedback()" class="h_row_center" style="cursor: pointer;">
            <div class="review_star_big" style="margin-left: -2px;"><span style="width: 98%;">별점 평균</span></div>
    ...
    <div class="flipsnap_container"
        ...
        <div class="flipsnap_list"
            ...
            <div class="h_row_center"
                ...
                <img src="https://img.hourplace.co.kr/temp/images/2019/05/13/52980499-0a22-3d0a-9545-e324879c9c19.jpg?s=1440x960&t=cover&q=80"
                    style="width: 100%;height: 100%;object-fit: cover;">
            </div>
            <div class="h_row_center"
                style="width: 100%; position: relative; transform: translate3d(0px, 0px, 0px); backface-visibility: hidden; flex-shrink: 0;">
                <img src="//img.hourplace.co.kr/temp/images/2019/05/13/eac757fa-801d-3de4-9b6e-04532816ffd6.jpg?s=1440x960&amp;t=cover&amp;q=80"
                    style="width: 100%; height: 100%; object-fit: cover;">
            </div>
            <div class="h_row_center"
                style="width: 100%; position: relative; transform: translate3d(0px, 0px, 0px); backface-visibility: hidden; flex-shrink: 0;">
                <img src="//img.hourplace.co.kr/temp/images/2019/05/13/424ca485-0edc-3ebb-aee0-c34a689a6166.jpg?s=1440x960&amp;t=cover&amp;q=80"
                    style="width: 100%; height: 100%; object-fit: cover;">
            </div>
            <div class="h_row_center"
                style="width: 100%; position: relative; transform: translate3d(0px, 0px, 0px); backface-visibility: hidden; flex-shrink: 0;">
                <img src="//img.hourplace.co.kr/place/user/1017/2021/06/05/9308486f-bacc-34b0-ac3f-587ba04a7bd1?s=1440x960&amp;t=cover&amp;q=80"
                    style="width: 100%; height: 100%; object-fit: cover;">
            </div>
            <div class="h_row_center"
                style="width: 100%; position: relative; transform: translate3d(0px, 0px, 0px); backface-visibility: hidden; flex-shrink: 0;">
                <img src="//img.hourplace.co.kr/temp/images/2019/05/13/364f8bd3-f6bd-39c6-a212-c3f8b6f01538.jpg?s=1440x960&amp;t=cover&amp;q=80"
                    style="width: 100%; height: 100%; object-fit: cover;">
            </div>
            <div class="h_row_center"
                style="width: 100%; position: relative; transform: translate3d(0px, 0px, 0px); backface-visibility: hidden; flex-shrink: 0;">
                <img src="//img.hourplace.co.kr/temp/images/2019/05/20/62a82469-bcc4-3b3a-9035-5d6c8105c3c2.jpg?s=1440x960&amp;t=cover&amp;q=80"
                    style="width: 100%; height: 100%; object-fit: cover;">
            </div>
            <div class="h_row_center"
                style="width: 100%; position: relative; transform: translate3d(0px, 0px, 0px); backface-visibility: hidden; flex-shrink: 0;">
                <img src="//img.hourplace.co.kr/temp/images/2019/05/23/f578a436-280b-3f73-8af2-269a5d7b6b39.jpg?s=1440x960&amp;t=cover&amp;q=80"
                    style="width: 100%; height: 100%; object-fit: cover;">
            </div>
            <div class="h_row_center"
                style="width: 100%; position: relative; transform: translate3d(0px, 0px, 0px); backface-visibility: hidden; flex-shrink: 0;">
                <img src="//img.hourplace.co.kr/temp/images/2019/05/23/8eb8ccf0-84c4-3a39-85b6-ed0466a22129.jpg?s=1440x960&amp;t=cover&amp;q=80"
                    style="width: 100%; height: 100%; object-fit: cover;">
            </div>
            <div class="h_row_center"
                style="width: 100%; position: relative; transform: translate3d(0px, 0px, 0px); backface-visibility: hidden; flex-shrink: 0;">
                <img src="//img.hourplace.co.kr/temp/images/2019/05/23/4b34c334-aa6d-3b1d-81f4-96720e205542.jpg?s=1440x960&amp;t=cover&amp;q=80"
                    style="width: 100%; height: 100%; object-fit: cover;">
            </div>
            <div class="h_row_center"
                style="width: 100%; position: relative; transform: translate3d(0px, 0px, 0px); backface-visibility: hidden; flex-shrink: 0;">
                <img src="//img.hourplace.co.kr/temp/images/2019/06/17/9b8ac58f-07e7-3023-8bd4-8ee986e5599d.jpg?s=1440x960&amp;t=cover&amp;q=80"
                    style="width: 100%; height: 100%; object-fit: cover;">
            </div>
            <div class="h_row_center"
                style="width: 100%; position: relative; transform: translate3d(0px, 0px, 0px); backface-visibility: hidden; flex-shrink: 0;">
                <img src="//img.hourplace.co.kr/temp/images/2019/05/23/dc736664-ba13-3dde-92ca-f9ca6d1845c6.jpg?s=1440x960&amp;t=cover&amp;q=80"
                    style="width: 100%; height: 100%; object-fit: cover;">
            </div>
            <div class="h_row_center"
                style="width: 100%; position: relative; transform: translate3d(0px, 0px, 0px); backface-visibility: hidden; flex-shrink: 0;">
                <img src="//img.hourplace.co.kr/temp/images/2019/05/23/4c270b3c-8683-3db7-bb67-834412ef79f1.jpg?s=1440x960&amp;t=cover&amp;q=80"
                    style="width: 100%; height: 100%; object-fit: cover;">
            </div>
            <div class="h_row_center"
                style="width: 100%; position: relative; transform: translate3d(0px, 0px, 0px); backface-visibility: hidden; flex-shrink: 0;">
                <img src="//img.hourplace.co.kr/temp/images/2019/06/04/539a8fe0-cfe9-3d75-bb43-c37bc8ec5097.jpg?s=1440x960&amp;t=cover&amp;q=80"
                    style="width: 100%; height: 100%; object-fit: cover;">
            </div>
            <div class="h_row_center"
                style="width: 100%; position: relative; transform: translate3d(0px, 0px, 0px); backface-visibility: hidden; flex-shrink: 0;">
                <img src="//img.hourplace.co.kr/temp/images/2019/06/04/f7987a98-00b5-314a-b4b8-70665f1b6edb.jpg?s=1440x960&amp;t=cover&amp;q=80"
                    style="width: 100%; height: 100%; object-fit: cover;">
            </div>
            <div class="h_row_center"
                style="width: 100%; position: relative; transform: translate3d(0px, 0px, 0px); backface-visibility: hidden; flex-shrink: 0;">
                <img src="//img.hourplace.co.kr/temp/images/2019/06/04/f29c02c9-7dfb-36fe-963f-e1f6b97c851e.jpg?s=1440x960&amp;t=cover&amp;q=80"
                    style="width: 100%; height: 100%; object-fit: cover;">
            </div>
            <div class="h_row_center"
                style="width: 100%; position: relative; transform: translate3d(0px, 0px, 0px); backface-visibility: hidden; flex-shrink: 0;">
                <img src="//img.hourplace.co.kr/place/user/1017/2021/06/05/0a8a57b9-7366-3800-953a-a872e4d04c98?s=1440x960&amp;t=cover&amp;q=80"
                    style="width: 100%; height: 100%; object-fit: cover;">
            </div>
            <div class="h_row_center"
                style="width: 100%; position: relative; transform: translate3d(0px, 0px, 0px); backface-visibility: hidden; flex-shrink: 0;">
                <img src="//img.hourplace.co.kr/place/user/1017/2021/06/05/7bfa50d5-5af3-3a49-a25b-20e6a99c94d8?s=1440x960&amp;t=cover&amp;q=80"
                    style="width: 100%; height: 100%; object-fit: cover;">
            </div>
            <div class="h_row_center"
                style="width: 100%; position: relative; transform: translate3d(0px, 0px, 0px); backface-visibility: hidden; flex-shrink: 0;">
                <img src="//img.hourplace.co.kr/place/user/1017/2021/06/05/bf6f719e-dfb6-3257-85f6-6e0350e1b03a?s=1440x960&amp;t=cover&amp;q=80"
                    style="width: 100%; height: 100%; object-fit: cover;">
            </div>
            <div class="h_row_center"
                style="width: 100%; position: relative; transform: translate3d(0px, 0px, 0px); backface-visibility: hidden; flex-shrink: 0;">
                <img src="//img.hourplace.co.kr/place/user/1017/2021/06/05/bd269f4c-8aec-31ee-9515-6967696e9d77?s=1440x960&amp;t=cover&amp;q=80"
                    style="width: 100%; height: 100%; object-fit: cover;">
            </div>
            <div class="h_row_center"
                style="width: 100%; position: relative; transform: translate3d(0px, 0px, 0px); backface-visibility: hidden; flex-shrink: 0;">
                <img src="//img.hourplace.co.kr/place/user/1017/2021/06/05/01e49b66-498c-32c5-b63a-3ddfab51d8de?s=1440x960&amp;t=cover&amp;q=80"
                    style="width: 100%; height: 100%; object-fit: cover;">
            </div>
        </div>
    </div>

    <div style="width: 400px; position: absolute; top: 255px; left: 950px;">
        <!--예약 시작-->
        ...
        <div style="width: 100%; margin-top: 40px;">
            <div
                ...
                <div style="margin: 30px;">
                    <div class="h_row_center" style="margin-top: 8px; flex-wrap: wrap;">
                        <div class="h_center"
                    ...
                    <div style="margin-top: 8px; display: flex; flex-direction: row; align-items: flex-end;">
                        <p
                    ...
                    <div style="margin-top: 16px; height: 1px; background-color: rgb(231, 234, 238);"></div>
                    <div class="h_row_center" style="margin-top: 20px;">
                        ...
                        <div class="h_row_center" style="position: absolute; right: 0px; cursor: pointer;"><img
                    ...
                    <div>
                        ...
                        <input type="radio" id="room1" name="room" value="1" onchange="setDisplay()"> n번룸 <br>
                        <br>
                    </div>
              
                    <input type="radio" id="room2" name="room" value="2" onchange="setDisplay()"> n번룸2
        ...
        console.log(checked);
                    ...
                    <div id="divId" style="display: none;">
                        ...
                        <div id="divId">
                            ...
                            <p class="meetspace-info-desc">4m(가로) x 5m(세로) x 3m(높이)<br><br>블랙톤의 다크룸 입니다. 배치되어 있는 소품들은 제거
                                후 자유롭게 사용
                                가능합니다.</p>
                        </div>
                        <ul class="list_detail">
                            <li><span class="tit">공간유형</span> <span class="data"><span>촬영스튜디오 </span><span>호리존
                                    </span><span>라이브방송
                                    </span></span></li>
                            <li><span class="tit">예약시간</span> <span class="data">최소 1시간 부터</span></li>
                            <li><span class="tit">수용인원</span> <span class="data">최소 1명 ~ 최대 15명</span></li>
                            <!---->
                        </ul>
                        <div class="facility_wrap">
                            <ul class="facility_list">
                                <li><i class="sp_icon ico_alchole"></i> <span class="txt_name">
                                        주류반입
                                        <em class="br">가능</em></span></li>
                                <li><i class="sp_icon ico_table"></i> <span class="txt_name">
                                        의자/
                                        테이블</span></li>
                                <li><i class="sp_icon ico_fittingroom"></i> <span class="txt_name">
                                        탈의실
                                        <!---->
                                    </span></li>
                                <li><i class="sp_icon ico_food"></i> <span class="txt_name">
                                        음식물
                                        반입가능</span></li>
                                <li><i class="sp_icon ico_toilet"></i> <span class="txt_name">
                                        내부
                                        화장실</span></li>
                                <li><i class="sp_icon ico_nonsmocking"></i> <span class="txt_name">
                                        금연
                                        <!---->
                                    </span></li>
                                <li><i class="sp_icon ico_parking"></i> <span class="txt_name">
                                        주차
                                        <!---->
                                    </span></li>
                    ...
                    <div id="divId2" style="display: none;">
                        <div id="divId">
                            ...
                            <p class="meetspace-info-desc">7m(가로) x 5m(세로) x 3m(높이)<br><br>블랙톤의 다크룸 입니다. 배치되어 있는 소품들은 제거
                                후 자유롭게 사용
                                가능합니다.</p>
                        </div>
                        <ul class="list_detail">
            ...
            <div class="meetspace-radio">
                <div class="meetspace-radio-item">
                    <label>시간 단위 예약하기(최소 1시간 부터)</label>
              
<br>
                <!--예약 캘린더-->
              
                <input type="text" id="date" name="date" style="width:200px;">
                <label for="date" style="font-size: small;">(날짜 선택)</label>
                
                <br>
                <!--시간 선택-->
                <!--시작시간-->
              <input type="text" id="startTime" name="startTime" style="width:100px;">
              
              ~
<!--끝나는 시간-->
              <input type="text" id="endTime" name="endTime"  style="width:100px;">
              <label for="endTime" style="font-size: small;">(시간 선택)</label>

              <input type="number" name="person" id="person" min="1" value="1"/>
            <label for="person" style="font-size: small;">(인원수 선택)</label>
...
<input type="submit" id="Submitbutton" class="Submitbutton" value="예약하기" style="width: 400px; height: 50px; position: relative; left: -30px; text-align: center;">
    ...
    <div class="h_column_center" style="position:relative; left: px; bottom: -16px; width: 193px;">
    </div>
    ...
    <div style="position: relative; left: 800px;">
        ...
        <div style="margin-top: 12px; width: 100%; display: flex; flex-wrap: wrap;">
            <!--onclick 태그 시작-->
        ...
        <div class="h_row_center" style="margin-top: 24px; height: 110px; width: 100%;">
            <div class="h_center"
                style="margin-right: 15px; width: 170px; height: 110px; border-radius: 8px; background-color: rgb(250, 251, 251);">

                <!--평수-->

                <div class="h_column_center" style="width: fit-content; height: fit-content;"><img
                        src="https://s3.hourplace.co.kr/web/images/icon/area.svg" style="width: 32px; height: 32px;">
                    <p
            ...
            <div class="h_center"
                style="margin-right: 15px; width: 170px; height: 110px; border-radius: 8px; background-color: rgb(250, 251, 251);">
                <div class="h_column_center" style="width: fit-content; height: fit-content;"><img
                        src="https://s3.hourplace.co.kr/web/images/icon/floor.svg" style="width: 32px; height: 32px;">
                    <p
                        style="margin-top: 10px; font-size: 15px; font-weight: normal; font-stretch: normal; font-style: normal; line-height: 1.33; letter-spacing: normal; text-align: center; color: rgb(27, 29, 31);">
                        지상 n층
                    </p>
            ...
            <div class="h_center"
                style="margin-right: 15px; width: 170px; height: 110px; border-radius: 8px; background-color: rgb(250, 251, 251);">
                <div class="h_column_center" style="width: fit-content; height: fit-content;"><img
                        src="https://s3.hourplace.co.kr/web/images/icon/person.svg" style="width: 32px; height: 32px;">
                    <p
                        style="margin-top: 10px; font-size: 15px; font-weight: normal; font-stretch: normal; font-style: normal; line-height: 1.33; letter-spacing: normal; text-align: center; color: rgb(27, 29, 31);">
                        기본 n명
                    </p>
            ...
            <div class="h_center"
                style="margin-right: 15px; width: 170px; height: 110px; border-radius: 8px; background-color: rgb(250, 251, 251);">
                <div class="h_column_center" style="width: fit-content; height: fit-content;"><img
                        src="https://s3.hourplace.co.kr/web/images/icon/parking.svg" style="width: 32px; height: 32px;">
                    <p
                        style="margin-top: 10px; font-size: 15px; font-weight: normal; font-stretch: normal; font-style: normal; line-height: 1.33; letter-spacing: normal; text-align: center; color: rgb(27, 29, 31);">
                        주차 n대 가능
                    </p>
        ...
        <p
            ...
            [시간 엄수]<br>
            - 계약된 시간을 꼭 준수하여 주시기 바랍니다. <br>
            - 이용요금은 [시작시간] 및 [종료시간]으로 계약됩니다.<br>
            - 촬영준비 및 세팅, 장비 철수 및 장소 원상복구 시간은 계약시간에 포함 되어있습니다.<br>
            - 계약된 촬영시간을 초과할 경우 호스트가 추가결제를 요청할 수 있습니다.<br> <br>
            [파손주의]<br>
            삼각대, 조명, 달리, 레일, 철제박스, 기타 장비로 인한 나무바닥과 벽지 파손에 꼭 주의 해주세요. (가정집 내부에서 촬영하신다면 달리와 레일 설치는 금지되어 있습니다.)<br>
            - 준비물: 간단한 돗자리나 모포, 테니스 공을 준비해서 장비 밑에 꼭 깔아 공간을 보호해 주세요.<br>
            - 파손시: 현장에서 함께 확인 &gt; 사진 촬영 &gt; 견적 확인 후, 배상 요청을 진행하게 됩니다.<br> <br>
            [스탭인원]<br>
            설정한 최대 스탭인원이 지켜지지 않을 경우, 호스트가 촬영을 취소하거나 추가결제를 요청할 수 있습니다.<br> <br>
            [취식금지]<br>
            공간에서 취식은 항상 금지 되어있습니다. 부득이한 경우 호스트에게 먼저 양해를 꼭 구해주세요.<br> <br>
            [에티켓]<br>
            - 주변 주민들을 위해 기본 에티켓을 지켜주세요.<br>
            - 주변 야외 촬영은 불가능합니다.<br>
            - 촬영 도중 발생한 쓰레기는 모두 정리해주셔야 합니다.<br>
            - 주차는 안내된 주차대수에 한해 제공됩니다.<br>
        ...
        <div onclick="toggle_place_map()" class="h_center"
            ...
            <div class="h_row_center"><img src="https://s3.hourplace.co.kr/web/images/icon/place.svg"
        ...
        <div id="place_map" style="position: relative; display: none; margin-top: 20px; width: 100%; height: 300px;">
            <div id="map" style="background: white; overflow: hidden; width: 100%; height: 100%;">
                지도
            </div>
            <div
                ...
                <button onclick="setCenter()" style="width: 100%; height: 100%;">장소로 이동</button>
            </div>
        </div>
        ...
        <div style="width: 100%; height: 1px; background-color: rgb(231, 234, 238);"></div>
        <!--주변 정보-->
        <p
            style="margin-top: 40px; font-size: 24px; font-weight: bold; font-stretch: normal; font-style: normal; line-height: 1.33; letter-spacing: -0.3px; color: rgb(27, 29, 31);">
            주변 정보 샘플입니당
        ...
        <!--리뷰 시작-->
            ...
            <div class="h_row_center" style="margin-top: 40px; position: relative;">
                ...
                <p
                    ...
                    45
                </p> <img src="https://s3.hourplace.co.kr/web/images/icon/gold_star.svg"
            ...
            <!--리뷰 사진 보기-->
            <div class="flipsnap_container_photo_feedbacks" style="margin: 30px 0px 0px; overflow: hidden;">
            ...
            <div style="margin-top: 5px;">
                <div
                    ...
                    <div style="margin-top: 6px;">
                        <!--리뷰 별점 시작-->
                        <div class="review_star"><span style="width: 100%;">몇점인지 들어가는 곳</span></div>
                    </div>
                    <div class="h_row" style="justify-content: space-between;">
                        <p
                ...
                <div class="h_row_center"
                    ...
                    <div style="position:relative; width: 860px;padding-top: 40px; height: 100%">
                        ...
                        <p
                            ...
                            (주)먼치팩토리는 통신판매중개자로서, 통신판매의 당사자가 아니라는 사실을 고지하며 상품의 예약, 이용 및 환불 등과 관련한 의무와 책임은 각 판매자에게
                            있습니다.
                        </p>
