...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" href="<c:url value="/resources/custom/css/card.css" />" />
...
<div id="banner" style="position: relative; top: 100px;">
  <div style="position: relative; width: 1280px; height: 100%;  left: -220px; margin: auto;">
...
<!--메인 바디 카드 레이아웃-->
  ...
  <div style="flex-direction: row; display: flex; justify-content: center; position: relative; ">
    <div style="display: flex; flex-flow: row wrap; min-width: 1160px; max-width: 1160px;">
      <div style="margin-top: 60px; width: 274px; margin-right: 21px;">
      
        <div onclick=" " class="h_row_center h_pc_category_header" style="height: 40px; width: 100%;"> <!--URL Mapping-->
        ...
        <img src="<c:url value="/resources/custom/icon/chevron_right_b.svg" />" class="h_pc_category_header_chevron" style="width: 20px; height: 20px;"></div> 
          ...
          <p>아파트
        </p></div> <div onclick=" " class="h_center h_hover_button right_side_button button_font_style">
          <p>주택
        </p></div> <div onclick=" " class="h_center h_hover_button left_side_button button_font_style">
          <p>빌라
        </p></div> <div onclick=" " class="h_center h_hover_button right_side_button button_font_style">
          <p>원룸
        </p></div> <div onclick=" " class="h_center h_hover_button left_side_button button_font_style">
  ...
  <div style="margin-top: 60px; width: 274px; margin-right: 21px;">
    <div onclick=" " class="h_row_center h_pc_category_header" style="height: 40px; width: 100%;">
    <div style="width: 24px; height: 24px; margin: 0px 8px 0px 0px;">
      </div> 
            <!-- 스튜디오 -->
            <!--온 클릭 이벤트 OnClick Event-->
...
<div style="flex-direction: row; display: flex; justify-content: center;">
  <div style="position: relative; width: 1160px; margin-top: 40px;">
    ...
    <div class="h_column_center" style="width: 100%;">
      ...
      <div onclick="hourplace_v2.userLog('W', '/', 'click', 'category', 'all');window.location.href='/category';" class="h_center h_hover_button" style="width: 280px; height: 56px; border-radius: 8px; background-color: rgb(245, 249, 255); cursor: pointer;">
...
<div style="flex-direction: row; display: flex; justify-content: center; background-color: rgb(250, 251, 251); ">
  <div style="margin-top: 80px; margin-bottom: 80px; width: 1176px;">
    <div class="h_row_center">
      <!--onclick="" 신규 등록 장소 목록-->
      <div onclick=" " style="padding-left: 10px; cursor: pointer;">
        <div class="h_row_center new_reco_m_title" style="padding: 0px 0px 0px 0px;">
          
<p>
  신규등록 장소 추천
</p>
</div> 
<div class="h_row_center new_reco_s_title" style="margin-top: -32px;">
    <p>맞춤 추천 더보기
    </p>
...
<div style="flex-direction: row; display: flex; justify-content: center; background-color: rgb(250, 251, 251);">
  <div style="margin-top: 80px; margin-bottom: 80px; width: 1176px;">
    <div class="h_row_center rating_reco_m_title" style="position: relative;">

      <!--onclick event 이주의 인기 장소 리스트로 -->
      <div onclick=" " style="padding-left: 10px; cursor: pointer;">
        <p>이 주의 인기 장소</p> 
        <div class="h_row_center rating_reco_s_title" style="margin-top: -32px;">
          <p>인기 장소 더보기</p> 
        </div>
      </div> 
